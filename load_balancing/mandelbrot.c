...
/*
	...
	for (i = start; i < (end < args->height ? end : args->height) ; i++)
*/
	for(i=thread_id;i<args->height; i += NB_THREADS) {
	
#elif LOADBALANCE == 2 && NB_THREADS != 0
